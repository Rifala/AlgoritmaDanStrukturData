...
public class Students {         //membuat getter dan setter
    private String _nim;        //block var yang ingin dibuat getter dan setter
    private String _name;       //klik kanan pilih generate lalu getter and setter
