...
public class MainActivity extends JFrame {
    ...
    public void setTopPanel(){
        JPanel _panelTop = new JPanel(new GridLayout());
    ...
    public void setStokPanel()throws IOException{
        ...
        for (int index = 0; index < _listItem.size(); index++){
            ...
            _labelPic[index] = new JLabel("<html>Code : " + _listItem.get(index).get_pluCode()
                                            + "<br/>Name : " + _listItem.get(index).get_pluName()
                                            + "<br/>Size : " + _listItem.get(index).get_size()
                                            + "<br/>" + _listItem.get(index).get_description()
                                            + "<br/>Price : " + _listItem.get(index).get_price()
                                            + "<br/>");

            String _PATH = "/home/fadia/Pictures/";
            imageIcons[index] = new ImageIcon(_PATH + fileName);        //load the image to a imageIcon
            Image image1 = imageIcons[index].getImage();        //transform it??
    ...
    public void setSearchPanel(){
        ...
        _searchPanel.setToolTipText("Type keyword . . .");
